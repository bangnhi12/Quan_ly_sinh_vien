...
CREATE TABLE Nganh_MonHoc (
    ...
    CONSTRAINT fk_nganh_monhoc_nganh FOREIGN KEY (MaNganh) REFERENCES Nganh(MaNganh),
    CONSTRAINT fk_nganh_monhoc_monhoc FOREIGN KEY (MaMH) REFERENCES MonHoc(MaMH)
);
